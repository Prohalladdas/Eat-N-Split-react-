  ...
  return (
    <div className="app">
      <div className="sidebar">
        <FriendsList friends={friends} onSelection={handleSelected} selectedFriend={selectedFriend} />
...
function FormSplitBill({ selectedFriend, onSpliteBill }) {
  ...
  return (
    <form className="form-split-bill" onSubmit={handleSubmit}>
      ...
      <input type="test" value={paidByUser} onChange={(e) =>
        setPaidByUser(
      ...
      <input type="test" disabled value={paidByFriend} />
